...
import matt.springframework.recipebook.springrecipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2), tableUOM));
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, minced", new BigDecimal(2), eachUOM));
        guacRecipe.addIngredient(new Ingredient("Cilantro", new BigDecimal(2), tableUOM));
        ...
        tacoRecipe.addIngredient(new Ingredient("Ancho Chili Powder", new BigDecimal(2), tableUOM));
        ...
        tacoRecipe.addIngredient(new Ingredient("finely grated orange zestr", new BigDecimal(1), tableUOM));
        tacoRecipe.addIngredient(new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tableUOM));
        tacoRecipe.addIngredient(new Ingredient("Olive Oil", new BigDecimal(2), tableUOM));
        tacoRecipe.addIngredient(new Ingredient("boneless chicken thighs", new BigDecimal(4), tableUOM));
        ...
        tacoRecipe.addIngredient(new Ingredient("medium ripe avocados, slice", new BigDecimal(2), eachUOM));
        ...
        tacoRecipe.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), teaspoonUOM));
